...
const Game = {
    ...
    handleMatch(card1, card2) {
        ...
        // 计算得分：基础100分 + 剩余时间奖励
        const timeBonus = Math.floor(this.state.timeLeft / this.state.totalTime * 50);
    ...
    handleMismatch(card1, card2) {
        ...
        // 扣除时间
        this.state.timeLeft = Math.max(0, this.state.timeLeft - GAME_CONFIG.timePenalty);
    ...
    levelComplete() {
        ...
        // 保存分数
        const playerName = Storage.getLeaderboard(this.state.levelId).length === 0 ? '' : '';
